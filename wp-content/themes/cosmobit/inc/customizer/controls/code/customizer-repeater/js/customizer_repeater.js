...
jQuery(document).ready(function () {
    ...
    cosmobit_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-cosmobit_information3_option' || parentid == 'customize-control-cosmobit_information6_option'  || parentid == 'customize-control-cosmobit_information5_option'  || parentid == 'customize-control-cosmobit_information8_option')
		{	
			var totalItems = jQuery("#customize-control-cosmobit_information3_option .customizer-repeater-general-control-repeater-container, #customize-control-cosmobit_information6_option .customizer-repeater-general-control-repeater-container, #customize-control-cosmobit_information5_option .customizer-repeater-general-control-repeater-container, #customize-control-cosmobit_information8_option .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 4){
			  jQuery( "#customize-control-cosmobit_information_option_upsale .desert-companion-upgrade-message" ).show();
			  return false;   
			}
