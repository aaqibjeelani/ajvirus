...
Alexia WordPress Theme, Copyright (C) 2023, Themes Daddy
Alexia is distributed under the terms of the GNU GPL

Flixita WordPress Theme, Copyright (C) 2023, Themes Daddy.
Flixita WordPress Theme is distributed under the terms of the GNU GPL
...
License: GNU General Public License (https://github.com/TGMPA/TGM-Plugin-Activation/blob/develop/LICENSE.md)

== Screenshots ==
All Alexia images are licensed under [CC0] (https://creativecommons.org/publicdomain/zero/1.0/)

Image for theme screenshot 
License:  CC0 Public Domain, Creative Commons Zero(https://pxhere.com/en/license)
Source: https://stocksnap.io/photo/business-people-DUXISHKTT3 , https://pxhere.com/en/photo/1433619
...
@Version 1.0.5
* Block Quote Color Issue Fixed

@Version 1.0.4
* Block Author Style Issue Fixed

@Version 1.0.3
* Block Calendar Caption Style Issue Fixed

@Version 1.0.2
* Block Image Caption Style Issue Fixed
