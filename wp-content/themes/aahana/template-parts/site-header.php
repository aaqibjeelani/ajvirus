...
<header id="dt__header" class="dt__header header--fourteen">
		...
		<div class="dt__header-navwrapper">
			<div class="dt__header-navwrapperinner">
				...
				<div class="dt__navbar dt-d-none dt-d-lg-block">
					<div class="dt__navbar-wrapper <?php if($cosmobit_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','aahana'); endif; ?>">
				...
				<div class="dt__mobilenav <?php if($cosmobit_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','aahana'); endif; ?> dt-d-lg-none">
